...
const Inputs = ({ setSearchTerm, onSearch }) => {
  const handleSearch = (e) => {
    setSearchTerm(e.target.value);
  };

  return (
    <div className="inputs_recipe">
      <input type="id" placeholder="What do you want to cook?" onChange={handleSearch} />
      <button className="try" onClick={onSearch}>find</button>
    </div>
  );
};
const dataRecipe = [
      ...
      <div className="container">
        <div className="back_recipes">
          <div className="container-main">
            ...
            <Inputs setSearchTerm={setSearchTerm} onSearch={handleSearch} />
